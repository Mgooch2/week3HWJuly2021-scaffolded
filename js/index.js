...
function compareTwo() {
  ...
  if(opened.length ===2 && opened[0].src === opened[1].src){
    ...
    //use getElementByID to get audio, store in mySound. make mySound play
    mySound = document.getElementById('audio1');
    mySound.play();
    ...
    //use getElementByID to get audio, store in mySound. make mySound play
    mySound = document.getElementById('audio2');
    mySound.play();
...
//use getElementByID to get audio, store in mySound. make mySound play
mySound = document.getElementById('audio3');
mySound.play();
